export const dict = {
  ...
  "settings.autocomplete.provider.title": "Provider",
  "settings.autocomplete.provider.description": "Select the autocomplete provider for inline code suggestions",
  "settings.autocomplete.provider.kilo": "Kilo Gateway",
  "settings.autocomplete.provider.openaiCompatible": "OpenAI Compatible",
  "settings.autocomplete.openai.baseUrl.title": "Base URL",
  "settings.autocomplete.openai.baseUrl.description": "API endpoint URL (e.g. http://localhost:11434/v1)",
  "settings.autocomplete.openai.baseUrl.placeholder": "http://localhost:11434/v1",
  "settings.autocomplete.openai.apiKey.title": "API Key",
  "settings.autocomplete.openai.apiKey.description": "Optional API key for the provider",
  "settings.autocomplete.openai.apiKey.placeholder": "sk-... (optional)",
  "settings.autocomplete.openai.model.title": "Model",
  "settings.autocomplete.openai.model.description": "Model name to use for completions",
  "settings.autocomplete.openai.model.placeholder": "e.g. qwen2.5-coder, codellama",
